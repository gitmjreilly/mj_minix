...
xst -ifn xst.scr
move papilio_pro_32_50_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\papilio_pro_32_50_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc papilio_pro_32_50_exdes.ucf papilio_pro_32_50_exdes

echo 'Running map'
map -timing -pr b papilio_pro_32_50_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm papilio_pro_32_50_exdes -w routed.ncd routed.vhd
cd ..
