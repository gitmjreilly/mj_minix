...
xst -ifn xst.scr
move jam_test_clock_1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\jam_test_clock_1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc jam_test_clock_1_exdes.ucf jam_test_clock_1_exdes

echo 'Running map'
map -timing -pr b jam_test_clock_1_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm jam_test_clock_1_exdes -w routed.ncd routed.vhd
cd ..
